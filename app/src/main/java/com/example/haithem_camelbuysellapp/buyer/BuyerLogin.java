...
public class BuyerLogin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            public void onClick(View v) {
                if (valid()) {
                    if(nInfo!=null && nInfo.isConnected()) {
                        ...
                        firebaseAuth.signInWithEmailAndPassword(ema_user, pas_user).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                            ...
                            public void onComplete(@NonNull Task<AuthResult> task) {
                                if (task.isSuccessful()) {
                                    ...
                                    editor.putString("name", "buyer");
                                    editor.apply();
                                    //end

                                    Toast.makeText(BuyerLogin.this, "Successful Login", Toast.LENGTH_LONG).show();
                        ...
                        Toast.makeText(BuyerLogin.this, "Network is not available", Toast.LENGTH_LONG).show();}
        ...
        sign.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(BuyerLogin.this, BuyerRegistration.class));
                finish();
            }
        });
        ...
        forgetP.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(BuyerLogin.this, ForgetPassword.class));
                finish();
            }
        });
    ...
    public void onBackPressed() {
        startActivity(new Intent(BuyerLogin.this, UserType.class));
        finish();
    }
}